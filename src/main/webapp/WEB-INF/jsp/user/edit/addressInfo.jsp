...
<t:paginabasica title="${edit} ${title.toLowerCase()}">
    <jsp:body>
        <ol class="breadcrumb">
            ...
            <li><a href="${pageContext.request.contextPath}/user/profile/${loggedUser.id}.html#main-address-info"><fmt:message key="profile.title" bundle="${lang}"/></a></li>
        ...
        <form:form cssClass="form-horizontal" method="post" modelAttribute="addressInfoForm">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a class="btn btn-warning" href="${pageContext.request.contextPath}/user/profile/${loggedUser.id}.html#main-address-info"><span class="glyphicon glyphicon-backward"></span> <fmt:message key="general.back" bundle="${lang}"/> </a>
                </div>
            </div>
        </form:form>
    </jsp:body>
